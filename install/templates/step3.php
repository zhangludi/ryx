      ...
      <div class="server">
        <table width="100%">
		  ...
		  <tr>
            ...
            <td><input type="text" name="dbhost" id="dbhost" value="<?php echo BASE_HOST;?>" class="input"></td>
          ...
          <tr>
            ...
            <td><input type="text" name="dbuser" id="dbuser" value="<?php echo BASE_USER;?>" class="input"></td>
            <td><div id="J_install_tip_dbuser"></div></td>
          </tr>
          <tr>
            <td class="tar">数据库密码：</td>
            <td><input type="password" name="dbpw" id="dbpw" value="<?php echo BASE_PWD;?>" class="input" autoComplete="off" onBlur="TestDbPwd(0)"></td>
            <td><div id="J_install_tip_dbpw"></div></td>
          </tr>
          <tr>
            <td class="tar">数据库名：</td>
            <td><input type="text" name="dbname" id="dbname" value="<?php echo DATABASE_NAME;?>" class="input"></td>
        ...
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="manager" id="manager" value="<?php echo USER_NAME;?>" class="input"></td>
            <td><div id="J_install_tip_manager"></div></td>
          </tr>
          <tr>
            <td class="tar">管理员密码：</td>
            <td><input type="password" name="manager_pwd" id="manager_pwd" class="input" value="<?php echo USER_PWD;?>" autoComplete="off"></td>
