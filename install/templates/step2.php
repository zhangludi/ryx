  ...
  <section class="section">
    ...
    <div class="server">
      ...
      <table width="100%">
		...
		?>   
                <tr>
                  <td>apps/Common/Conf/config_database.php</td>
                  <td>读写</td>
                  <?php
                     if (is_writable(SITEDIR.'apps/Common/Conf/config_database.php')){
                ...
                <tr>
                  <td>apps/Common/Conf/config.php</td>
                  <td>读写</td>
                  <?php
                     if (is_writable(SITEDIR.'apps/Common/Conf/config.php')){
                        echo "<td><span class='correct_span'>√</span>可写 </td>
                              <td><span class='correct_span'>√</span>可读</td>";                 
                     }else{
                         $err++;
