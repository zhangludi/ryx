...
class AlidayuClient
{
    ...
    {
        $this->appKey    = $appKey ?: getConfig('AlidayuAppKey');
        $this->appSecret = $appSecret ?: getConfig('AlidayuAppSecret');
        $this->apiURI    = getConfig('AlidayuApiEnv') ? self::API_URI : self::SANDBOX_URI;
    }
