...
class AlidayuClient
{
    ...
    {
        $this->appKey    = $appKey ?: C('Alidayu_config')['AlidayuAppKey'];
        $this->appSecret = $appSecret ?: C('Alidayu_config')['AlidayuAppSecret'];
        $this->apiURI    = C('Alidayu_config')['AlidayuApiEnv'] ? self::API_URI : self::SANDBOX_URI;
    }
