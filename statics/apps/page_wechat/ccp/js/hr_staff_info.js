...
$('#line').css('height',($('#flow_list').height()-$('#flow_list').find('li').last().height()));
    		...
    		if(ret.status==1){
				...
				if(ret.data.log_list!==null&&ret.data.log_list!==''){
					for(var i=0;i<ret.data.log_list.length;i++){
						$('#log_list').append(
							'<div class="pl-12em pr-12em pt-15em pb-15em bb-1-eb bg-color-whiter">'+
					   			'<p class="f-12em lh-15em f-w color-33">'+
					   			ret.data.log_list[i].add_time+
					   			'</p>'+
					   			'<div class="f-15em lh-17em color-99 mt-10em">'+
