...
//									'</div>'+
				                    '<div class="pull-left w-216em mt-12em">'+
				                        '<div class="f-16em color-12 f-w">'+clearNull(ret.data[i].article_title,'无').substring(0,25)+'</div>'+
				                        '<div class="pull-left color-a4 f-11em pt-5em">'+ret.data[i].add_staff+'</div>'+
				                        '<div class="pull-right color-a4 f-11em pt-5em">'+clearNull(ret.data[i].add_time,'0').substring(0,10)+'</div>'+
				                    '</div>'+
				               '</div>'+
							'</li>'
		    			)
