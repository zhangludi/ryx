		    				...
		    				'<li class="mb-12em over-h bb-3em-e6 pb-10em" onclick="openPartyWork(\'cms_partyWork_info_header\','+ret.data[i].article_id+')">'+
								...
								'<div class="pull-left over-h w-230em ml-8em">'+									
				                    '<div class="pull-left w-216em mt-12em">'+
				                        '<div class="f-16em color-33 f-w">'+InterceptField(ret.data[i].article_title,'无',25)+'</div>'+
				                        '<div class="pull-left color-a4 f-11em pt-5em">'+clearNull(ret.data[i].add_time,'0').substring(0,10)+'</div>'+
				                        '<div class="pull-right color-a4 mt-5em f-11em">'+clearNull(ret.data[i].add_staff,'0')+'</div>'+
