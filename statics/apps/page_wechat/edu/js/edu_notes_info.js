    		...
    		if(ret.status==1){
				...
				if(ret.data.material.type_video=='no'){
					$('#notes_info_con').append(
						...
						'<img class="w-350em h-201em m-a" src='+((ret.data.material.material_thumb!=null)?(localStorage.url+ret.data.material.material_thumb):"../../../statics/images/images_edu/edu_special_learn1.png")+' alt="" />'+
						'<p class="pt-12em pb-15em text-align pl-12em pr-12em">'+ret.data.material.material_title+'</p>'+
						'</div>'
					)
					...
					$('#notes_info_con').append(
						...
						'<video style="object-fit:fill" class="w-100b h-201em m-a" src='+((ret.data.material.material_vedio!=null)?(localStorage.url+ret.data.material.material_vedio):"../../../statics/images/images_edu/edu_special_learn1.png")+' controls="controls">'+
						'</video>'+
						'<p class="pt-12em pb-15em text-align pl-12em pr-12em">'+ret.data.material.material_title+'</p>'+
						'</div>'
					)
