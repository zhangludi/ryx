    		...
    		$('#list1 .no_more').hide();
	    		...
	    		//type_video=yes视频  /type_video=no文章   /material=null日常笔记 	
					...
					if(ret.data[i].type_video=='yes'){
						$('#list').append(
						'<div class="edu_notes_con mt-12em mb-12em p-12em clearfix w-100b" onclick="openLearnInfo(\'edu_learn_videoInfo_header\','+ret.data[i].material.material_id+')">'+
						'<div class="pull-left mr-8em">'+
						...
						'<div class="icon_regular f-16em color-12 f-w">'+InterceptField(ret.data[i].material.material_title,'无标题',16)+'</div>'+
						...
						$('#list').append(
				    		'<div class="edu_notes_con mt-12em p-12em clearfix w-100b" onclick="openLearnInfo(\'edu_learn_info_header\','+ret.data[i].material.material_id+')">'+
				    			'<div class="pull-left mr-8em">'+
				    			...
				    			'<div class="f-11em color-a4 mt-9em">'+clearNull(ret.data[i].topic_type,'无')+'</div>'+		    			
				    			'</div>'+
				    			'<div class="pull-left">'+
				    			'<img class="w-80em h-58em over-h" src='+((ret.data[i].material.material_thumb!=null)?(localStorage.url+ret.data[i].material.material_thumb):"../../../statics/images/images_edu/edu_special_learn1.png")+' alt="" />'+		    					    			
				    			'</div>'+		    			
				    			'</div>'+		    			
				    			'</div>'+		    			
				    		'</div>'	
...
/*laydate.render({
	...
	,change: function(value, date, endDate){
        ...
        $.ajax({ 
            type : "POST", //提交方式 
            url : "{:U('Wechat/Edu/edu_notes_data')}",//路径 
