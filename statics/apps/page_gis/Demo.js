...
function notice(){
	...
	$.ajax({
		type:"POST",
		url:"http://jddev.sp11.cn/alertmsg/alertMsgJson",
		data:{
			limit:pagesize,
			page:1
		},
		...
		success:function(data){
				...
				new jBox('Notice', {
				  content: '<span style="background-color:red;display:inline-block;width:8px;height:8px;border-radius:100%;margin-right:10px"></span>'+data.data[0].alert_title+'',
				  color: '#fff'
				});
				pagesize++;
		}
