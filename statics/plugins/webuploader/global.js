...
jQuery(function() {
    ...
    function loadComments( data ) {
        for (var i = 0; i < data.length; i++) {
            ...
            $el.append('<div class="comment"><div class="commentheader"><div class="commentgravatar"><img src="../演示 - Web Uploader_files/' + cavatarlink + '" alt="" width="20" height="20"></div><a class="commentuser" href="../演示 - Web Uploader_files/' + cuserlink + '">' + cuser + '</a><a class="commentdate" href="../演示 - Web Uploader_files/' + clink + '">' + cdate + '</a></div><div class="commentbody">' + cbody + '</div></div>');
        }
    }
