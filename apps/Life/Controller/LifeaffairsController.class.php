...
class LifeaffairsController extends BaseController{
	 /**
	...
	public function life_affairs_index(){
		...
		$this->display("Lifearticle/life_article_index");
	}
	/**
	...
	public function life_affairs_table(){
		...
		$this->assign('type',1);
		$this->display("Lifearticle/life_article_table");
	}
	...
	public function life_affairs_table_data()
	{
		...
		$article_data['data'] = getAffairsList($cat_id,0,0,'',$keyword,$start_time,$end_time,'');
	...
	public function life_affairs_edit(){
		...
		$this->assign('type',1);
	    $this->display("Lifearticle/life_article_edit");
	}
	 /**
	...
	public function life_affairs_info(){
	   ...
	   $this->display("Lifearticle/life_article_info");
	}
	 /**
